...
//		aLists.get(1).click();
		...
		// WebElement password =
		// driver.findElement(By.xpath("//input[@type='password'][@name='session[password]']"));
		// WebElement password =
		...
		WebElement firstName = driver
				.findElement(By.xpath("//div[contains(@class,'form-group row')]//input[@id='address_first_name']"));
